# Task 004 — Seurat integration

## Status
PENDING

## Goal
Integrate approved cells from the seven datasets into one traceable Seurat v5 object without erasing raw counts or biologically relevant Tumour–Adjacent variation.
...
- object checksum, size, cell count, feature count and Seurat/package versions recorded in Git-tracked report.
