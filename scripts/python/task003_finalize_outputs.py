...
def main() -> None:
    ...
    lines = [
        ...
        f"The final subset contains {int(nature['subset_n_cells']):,} cells and excludes non-HCC entities, including ICC-linked adjacent samples. It retains HCC tumor cells and AL cells only when the source sample identifier explicitly identifies an HCC sample; AL is harmonized to Adjacent.",
